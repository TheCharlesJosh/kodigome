...
**AMBABAAY, BANI, PANGASINAN**


Clustered Precinct ID: 55080005

Precincts in Cluster:
0016A, 0016B, 0018A, 0018B
...
1. NAVARRO, BENJIE (API) 2. PALAFOX, BOYING (NP)

VICE-MAYOR / Vote for 1
(Bumoto ng hindi hihigit sa 1)

1. AMON, ARTEMIO (API) 2. YAMAMOTO, GWEN (NP)
...
6. CATABAY, RONALDO
1. AMOSIG, BUDOT (API) 11. NAVARRO, JP (API)
(NP)

2. AMOSIG, FREBIEN JAKE
7. COLIS, FROILAN (API) 12. OLORES, AMY (IND)
(NP)

3. AMPLER, GRINGO (NP) 8. DOLLAGA, WARLIE (NP) 13. OLORES, JOVY (NP)

4. CAMBA, ALVIN (NP) 9. FIGUERRES, ZITA (NP) 14. OLORES, OKOY (NP)

10. JULIO, SOLOMON JR.
5. CAOILE, LALYN (API) 15. RIVERA, FILIPINA (API)
(IND)
...
|1. AMOSIG, BUDOT (API)|6. CATABAY, RONALDO (NP)|11. NAVARRO, JP (API)|16. RIVERA, MANDING (API)|
|2. AMOSIG, FREBIEN JAKE (NP)|7. COLIS, FROILAN (API)|12. OLORES, AMY (IND)|17. TALANIA, NOEL (API)|
|3. AMPLER, GRINGO (NP)|8. DOLLAGA, WARLIE (NP)|13. OLORES, JOVY (NP)|18. TONGSON, DOC TONGSON (IND)|
|4. CAMBA, ALVIN (NP)|9. FIGUERRES, ZITA (NP)|14. OLORES, OKOY (NP)||
|5. CAOILE, LALYN (API)|10. JULIO, SOLOMON JR. (IND)|15. RIVERA, FILIPINA (API)||
