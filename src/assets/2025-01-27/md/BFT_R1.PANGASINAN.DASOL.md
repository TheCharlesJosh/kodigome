...
**ALILAO, DASOL, PANGASINAN**


Clustered Precinct ID: 55190004
...
1. BERNAL, SADONG (NP) 2. NACAR, BABY (API)
...
6. DOMAGAS, JANONG
1. ABELLA, OPAW (NP) 11. RIVERA, JUN-JUN (NP)
(NP)

2. AQUINO, KENT ARVIN
7. ESPINOZA, SER (NP) 12. RIVERA, MANING (API)
(API)

8. GABUYO, ANGELO 13. SALANGA, MICHAEL
3. ASEO, JON RAY (NP)
EMMANUEL (NP) (API)

14. SAWAYSAWAY, MERCY
4. BRIZ, LEOSALD (API) 9. GARCIA, RICH (NP)
(API)

15. VERSOZA, MEMING
5. CARRERA, MARK (NP) 10. NACAR, BIDONG (API)
(API)
...
|1. ESPINOSA, NATANLA (API)|2. FONTELERA, IDOL (NP)|||
|MEMBER, SANGGUNIANG BAYAN / Vote for 8 (Bumoto ng hindi hihigit sa 8)||||
|1. ABELLA, OPAW (NP)|6. DOMAGAS, JANONG (NP)|11. RIVERA, JUN-JUN (NP)|16. VERZOSA, AYO (IND)|
|2. AQUINO, KENT ARVIN (API)|7. ESPINOZA, SER (NP)|12. RIVERA, MANING (API)|17. VITO, GERRY (API)|
|3. ASEO, JON RAY (NP)|8. GABUYO, ANGELO EMMANUEL (NP)|13. SALANGA, MICHAEL (API)||
|4. BRIZ, LEOSALD (API)|9. GARCIA, RICH (NP)|14. SAWAYSAWAY, MERCY (API)||
|5. CARRERA, MARK (NP)|10. NACAR, BIDONG (API)|15. VERSOZA, MEMING (API)||
