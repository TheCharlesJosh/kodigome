...
Clustered Precinct ID: 55420011
...
|1. CALUGAY, DONG (API)|2. CELESTE, ARTHUR JR. (NPC)|||
|VICE-MAYOR / Vote for 1 (Bumoto ng hindi hihigit sa 1)||||
|1. ARCINUE, JC (NPC)|2. MILLAN, MAX (API)|||
|MEMBER, SANGGUNIANG BAYAN / Vote for 8 (Bumoto ng hindi hihigit sa 8)||||
|1. AGBAYANI, ADONIS (IND)|6. EDROSOLAN, KENBERLY (API)|11. GARCIA, BONG (API)|16. RIGONAN, ALEXANDER JR. (API)|
|2. BELTRAN, MELODY (NPC)|7. EDROSOLAN-MENDOZA, APPLE (NPC)|12. GILLE, CAMILO (IND)|17. SABIDO, RAMON (NPC)|
|3. BENITO, RUDY (IND)|8. ESCOBEDO, FATIMA (IND)|13. OSANA, MHERLIE (API)|18. SISON, RAMIR (NPC)|
|4. BRUDO, SAMSON (API)|9. FONTANILLA, NELSON (API)|14. PEÑANUEVA, DOODS (NPC)|19. TABOY, GODOFREDO JR. (NPC)|
|5. CABURAO, DIONEIL (NPC)|10. GALACIO, LIZA (IND)|15. RADOVAN, REY (API)|20. VINLUAN, DANNY (NPC)|
