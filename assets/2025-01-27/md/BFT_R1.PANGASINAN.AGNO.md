...
Clustered Precinct ID: 55010004
...
|1. CELESTE, JOHN (NPC)|2. SISON, GUALBERTO (API)|||
|VICE-MAYOR / Vote for 1 (Bumoto ng hindi hihigit sa 1)||||
|1. BUNDAL, JHUN (NPC)|2. DOROMAL, JONATHAN (API)|||
|MEMBER, SANGGUNIANG BAYAN / Vote for 8 (Bumoto ng hindi hihigit sa 8)||||
|1. AMORES, ARNE (IND)|7. GIMELO, ATTY. MIKE SISON (API)|13. NIVERA, FRANCIS (IND)|19. SAGUN, LARRY (API)|
|2. CABALLERO, RICA (IND)|8. MANALASTAS, ELMER (API)|14. NIVERA, LORNA (API)|20. SISON, OBED (NPC)|
|3. CARBON, KENNEDY (NPC)|9. MONGE, CLARENCE JAY (API)|15. PECSON, JANDELL GLENN (NPC)|21. YADAO, FLORAMANTE (NPC)|
|4. CUATCHON, DAN (IND)|10. NAGAL, DIANNE (NPC)|16. ROSETE, CHARLIE DAVE (NPC)||
|5. DELA CONCHA, LYN (API)|11. NAVIDAD, LESTER ONYOK (API)|17. ROSETE, TOM (IND)||
|6. FEBLE, KRISTINE (API)|12. NILO, ELMO (NPC)|18. ROSETE-NOGUERA, MADELEINE(NPC)||
