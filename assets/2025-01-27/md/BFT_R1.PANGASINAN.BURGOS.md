...
**ANAPAO, BURGOS, PANGASINAN**


Clustered Precinct ID: 55160004
...
1. PASCUA, ALAIN 2. VALENZUELA, ALLAN
BUSTAMANTE (NP) (API)
...
5. BONODE, LOURINE MAE
1. ABELLA, MING (NP) 9. GINES, OSWARD (API)
(API)

2. BALISALISA, RONIE (API) 6. BONSATO, AMBONG (NP) 10. LACSON, ERICKA (API)

3. BONGAR, WOWIE 7. DE GUZMAN, WILSON JR. 11. NACAR, FRED
ABELLA (NP) (NP) CHRISTIAN (API)

12. NACORDA, LYNDON
4. BONODE, JORDAN (NP) 8. DOCTOR, DOMING (API)
GINEZ (NP)
...
|1. PASCUA, ALAIN BUSTAMANTE (NP)|2. VALENZUELA, ALLAN (API)|||
|VICE-MAYOR / Vote for 1 (Bumoto ng hindi hihigit sa 1)||||
|1. GUIANG, ALBERTO JR. (NP)||||
|MEMBER, SANGGUNIANG BAYAN / Vote for 8 (Bumoto ng hindi hihigit sa 8)||||
|1. ABELLA, MING (NP)|5. BONODE, LOURINE MAE (API)|9. GINES, OSWARD (API)|13. ROSETE, NORMAN (NP)|
|2. BALISALISA, RONIE (API)|6. BONSATO, AMBONG (NP)|10. LACSON, ERICKA (API)|14. TOLENTINO, ALVIN (NP)|
|3. BONGAR, WOWIE ABELLA (NP)|7. DE GUZMAN, WILSON JR. (NP)|11. NACAR, FRED CHRISTIAN (API)|15. VALENZUELA, KING (API)|
|4. BONODE, JORDAN (NP)|8. DOCTOR, DOMING (API)|12. NACORDA, LYNDON GINEZ (NP)||
