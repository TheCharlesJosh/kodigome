...
**SAN BARTOLOME, QUEZON CITY, NATIONAL CAPITAL**
**REGION - SECOND DISTRICT**

Clustered Precinct ID: 74041366

Precincts in Cluster:
2687A, 2687B, 2688A, 2688B,
...
1. DE GUZMAN, ATE ROSE
2. MALLARI, FIDELA (IND) 5. VARGAS, PM (LAKAS)
   (WPP)

3. LIN, ATE ROSE (IND) 4. RUSTIA, ANGEL JR. (IND)

MAYOR / Vote for 1
(Bumoto ng hindi hihigit sa 1)

5. VELASCO, DIOSDADO
1. BELMONTE, JOY (SBP) 3. JOTA, ROLANDO (IND)
   (IND)
1. CABALO, JONATHAN
1. NAVAT, NOLI (IND)
   (IND)
...
1. FAELANGCO, JUNE (IND) 2. INGLES, INVENTOR (IND) 3. SOTTO, GIAN (SBP)
...
1. CASTELO, KARL
2. MEDALLA, RAM (SBP) 7. PINEDA, ENZO (SBP)
   (AKSYON)

3. GADONG, KUYA J (IND) 5. MELENDEZ, AIKO (SBP) 8. QUEBAL, JONEL (IND)

4. LIBAN, SHAY (SBP) 6. ORTIGAS, ANGEL (IND) 9. SABE, ARPEE (IND)
...
| 1. DE GUZMAN, ATE ROSE (WPP)                                                 | 3. MALLARI, FIDELA (IND)           | 5. VARGAS, PM (LAKAS)             |                                    |
| 2. LIN, ATE ROSE (IND)                                                       | 4. RUSTIA, ANGEL JR. (IND)         |                                   |                                    |
| MAYOR / Vote for 1 (Bumoto ng hindi hihigit sa 1)                            |                                    |                                   |                                    |
| 1. BELMONTE, JOY (SBP)                                                       | 3. JOTA, ROLANDO (IND)             | 5. VELASCO, DIOSDADO (IND)        |                                    |
| 2. CABALO, JONATHAN (IND)                                                    | 4. NAVAT, NOLI (IND)               |                                   |                                    |
| VICE-MAYOR / Vote for 1 (Bumoto ng hindi hihigit sa 1)                       |                                    |                                   |                                    |
| 1. FAELANGCO, JUNE (IND)                                                     | 2. INGLES, INVENTOR (IND)          | 3. SOTTO, GIAN (SBP)              | 4. VILLARTA, DANTE (IND)           |
| MEMBER, SANGGUNIANG PANLUNGSOD / Vote for 6 (Bumoto ng hindi hihigit sa 6)   |                                    |                                   |                                    |
| 1. CASTELO, KARL (AKSYON)                                                    | 4. MEDALLA, RAM (SBP)              | 7. PINEDA, ENZO (SBP)             | 10. VARGAS, ALFRED (SBP)           |
| 2. GADONG, KUYA J (IND)                                                      | 5. MELENDEZ, AIKO (SBP)            | 8. QUEBAL, JONEL (IND)            | 11. VISAYA, JOSEPH JOE (SBP)       |
| 3. LIBAN, SHAY (SBP)                                                         | 6. ORTIGAS, ANGEL (IND)            | 9. SABE, ARPEE (IND)              |                                    |
